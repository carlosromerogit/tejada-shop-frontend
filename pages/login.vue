                ...
                <form class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <UCheckbox v-model="remember" name="remember" label="Recordarme"  class="hover:cursor-pointer"/>
                        </div>
                        <div class="text-sm">
                           <UButton color="transparent" class="hover:underline">Olvidaste tu contraseña?</UButton>
                        </div>
                    </div>
                    <div>
                ...
                <div class="mt-6">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="bg-white dark:bg-slate-900 px-2 text-slate-600 dark:text-white">O continuar con</span>
                        </div>
                    </div>
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        ...
                        <button
                              ...
                              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="#000000" width="800px" height="800px"
                    ...
                    <div class="m-auto mt-6 w-fit md:mt-8">
                        <span class="m-auto dark:text-gray-400">No tienes una cuenta?<UButton color="transparent" class="hover:cursor-pointer">Crear cuenta</UButton>
                        </span>
                    </div>
                </div>
            </div>
